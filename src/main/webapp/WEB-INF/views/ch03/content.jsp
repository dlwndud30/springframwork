...
<div class="card m-2">
   ...
   <div class="card-body">
      ...
      <div class="card m-2">
         ...
         <script>
            function requestGet() {
               const param1 = document.form1.param1.value;   //form의 name으로 접근 -> 거기서 또 name이 param1인 것
               const param2 = document.querySelector("#param2").value;  //param2라는 아이디로 접근
               const param3 = $("#param3").val();	//jqeury에서 아이디가 param3인 : jquery객체
               ...
               $.ajax({
                  ...
                  data: {
                     param1:param1, 
                     param2, //속성이름과 변수이름이 같을 때는 하나만 적어도 된다
                     param3, 
                     param4, 
                     param5
                  }
               })
               .done(() => {});  //성공적으로 응답이 왔을 때 얘가 실행된다
            }
      ...
      <div class="card m-2">
         ...
         <div class="card-body">
         	<a href="method3?param1=문자열1&param2=문자열2" class="btn btn-dark btn-sm">요청</a>
         </div>
   	  </div>
