...
public class Ch11Controller {
	...
	@PostMapping("/form2")
	public String hadleForm2(@ModelAttribute("member")Ch11Member member) {

		log.info(member);
		log.info("type: " + member.getMtype());
		log.info("job: " + member.getMjob());
		log.info("city: " + member.getMcity());
	...
	@PostMapping("/form3")
	public String hadleForm3(@ModelAttribute("member")Ch11Member member) {
		
		log.info(member);
		log.info("language: " + Arrays.toString(member.getMlanguage()));
		log.info("skill: " + Arrays.toString(member.getMskill()));
	...
	@PostMapping("/form4")
	public String hadleForm4(@ModelAttribute("member")Ch11Member member) {
