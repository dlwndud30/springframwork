...
//SimpleUrlAuthenticationSuccessHandler : 성공하면 무조건 거기로 가도록
//SavedRequestAwareAuthenticationSuccessHandler : 사용자가 원했던 요청을 기억했다가 로그인 성공하면 거기로 이동
...
public class Ch17AuthenticationSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
	...
	public void onAuthenticationSuccess(
			//onAuthenticationSuccess : 로그인이 성공하면 이게 자동으로 실행됨 -> 로그인 성공했을 때 실행하고 싶은 코드를 작성하면 된다
